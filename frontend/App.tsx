...
import Attendance from "./app/screens/Teacher/Attendance";
import DatesAttendance from "./app/screens/Teacher/DatesAttendance";
import PresentStudentsList from "./app/screens/Teacher/PresentStudentsList";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="LandingPage">
        ...
        />
        <Stack.Screen
          name="DatesAttendance"
          component={DatesAttendance}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="PresentStudentsList"
          component={PresentStudentsList}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    </NavigationContainer>
